...
public class Conector extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String dato = (String) miSesion.getAttribute("name");                // Obtengo el dato del jsp
            int cc = (int) miSesion.getAttribute("varia");
            ResultSet usuario = u.getUsuarioById(cc);
            request.getSession().setAttribute("cliente", usuario);  
            ResultSet ensayo = u.getEstadios();
            request.getSession().setAttribute("Boleteria", ensayo);
